  ...
  <header>
    ...
    <table style="width: 100%;">
			...
			<tbody style="background-color: #ff9800; ">
				...
				<th scope="col"> <?php if($key == "id_operacion"){ ?> <form action="modificar.php" method="POST"><button type="submit" name="<?php echo $key; ?>" value="<?php echo $value; ?>">Modificar</button></form> <?php } else{ echo $value; }?> </th>
